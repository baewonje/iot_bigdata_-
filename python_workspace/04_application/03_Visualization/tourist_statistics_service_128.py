...
access_key="55t4Ivy8JFzrnVt652YPTJnQxJswmaU%2B0qRVpmsmxwG15fTxRFETIjG5yAtFIQm3RDdtw2yEGtSYZK%2FoxccCBQ%3D%3D"
...
# 중국: 112/일본:130/미국:275
    ...
    for year in range(nStartYear, nEndYear):
        ...
        for item in jsonResult:
            ...
            VistYM.append(item['yyyymm'])
            i += 1

        with open('%s(%s)_해외방문객정보_%d_%d.json'\
                  %(krName,national_code,nStartYear,nEndYear-1),'w',encoding='utf-8') as outfile:
